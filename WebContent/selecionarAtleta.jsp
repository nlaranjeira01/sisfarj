...
<%@ page import="servlets.ListarAtleta" %>
<%@ page import="java.util.List" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Selecionar Atleta</title>
...
<body>
	<p align='center' id='title'>Lista de Atletas</p>
	<br>
	...
	<br><br>
	<div align='center' class="form-group" id="alterarAtleta">
		<form method="post" action="atualizarAtleta">
			<label for="sel1">Alterar atleta:</label>
			<select class="form-control" name="atleta" id='sel1'>
			<%
